    ...
    const load = async () => {
      try {
        ...
        const mapped = (data || []).map((n) => ({
          ...
          time: new Date(
            n.delivered_at || n.notification?.created_at || Date.now()
          ).toLocaleString(),
          ts: new Date(
            n.delivered_at || n.notification?.created_at || Date.now()
          ).getTime(),
          ...
          type: "general",
          details: n.notification?.message || "",
          course: null,
        }));
                  ...
                  >
                    <div className="flex items-start">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center justify-end te">
                          {(() => {
                            ...
                            if (t.includes("welcome")) {
                              return (
                                <a
                                  ...
                                  className="text-xs text-[#268FB6] hover:underline"
                                >
                                  Choose a course
                                </a>
                              );
                            ...
                            if (t.includes("profile")) {
                              return (
                                <a
                                  href="/profile"
                                  className="text-xs text-[#13485B] hover:underline"
                                >
                                  Edit profile
                                </a>
                              );
