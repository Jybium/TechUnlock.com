...
const PromotionBanner = () => {
  return (
    <div className="relative bg-pri10 w-[90%] mx-auto mb-[6rem] rounded z-40">
      <div className="flex flex-col items-center justify-center py-10 gap-y-7 w-5/6 mx-auto text-center">
        <h1 className="text-4xl font-semibold text-white w-5/6 mx-auto">
          Want to join our classes and learn at your own pace?
        </h1>
        <p className="text-2xl text-pri1 text-left">
