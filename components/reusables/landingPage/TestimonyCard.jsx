...
const TestimonyCard = ({ data }) => {
  return (
    <div className="relative z-50 w-full grid gap-y-4 bg-pri1 pt-5 lg:pt-16 lg:pb-5 lg:px-6 overflow-auto">
      ...
      <Image
        ...
        width={160}
        height={160}
        className="w-24 h-24 mx-auto rounded-full lg:absolute lg:-top-1/3 lg:left-[45%] shadow-md z-50"
      />
      {/* </div> */}
