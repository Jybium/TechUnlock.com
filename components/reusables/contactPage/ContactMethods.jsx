...
const ContactMethods = () => {
  return (
    <div className="py-[2rem] px-[1rem] lg:py-[4rem] lg:px-[3rem] bg-pri1 mb-10">
      <div className="grid gap-y-[2rem] lg:gap-y-[4rem]">
        <div className="grid gap-y-2 lg:gap-y-4 text-center">
          <p className="text-darkblue rounded-xl bg-[#D5F0F9] p-1 px-3 w-fit mx-auto">
            Contact us
          </p>
          <h2 className="font-semibold text-2xl lg:text-3xl text-darkblue">
